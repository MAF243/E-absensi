          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
            ...
            <div className="md:col-span-1 flex gap-4">
              <div className="flex-1">
                <label className="text-xs font-semibold text-slate-600 block mb-1.5">Kode MK <span className="text-red-500">*</span></label>
                <input 
                  type="text" 
              ...
              <div className="w-24">
                <label className="text-xs font-semibold text-slate-600 block mb-1.5">SKS <span className="text-red-500">*</span></label>
                <input 
                  type="number" min="1" max="6"
                  className="w-full bg-white border border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-xl px-4 py-2.5 outline-none font-medium text-sm transition-all text-slate-800 text-center" 
                  value={formData.sks} 
            ...
            {/* NAMA MK */}
            <div>
              <label className="text-xs font-semibold text-slate-600 block mb-1.5">Nama Mata Kuliah <span className="text-red-500">*</span></label>
              <input 
                type="text" 
            ...
            <div className="md:col-span-2">
              <label className="text-xs font-semibold text-slate-600 block mb-1.5">Dosen Pengampu <span className="text-red-500">*</span></label>
            ...
            {/* JURUSAN & ANGKATAN */}
            <div>
              <label className="text-xs font-semibold text-slate-600 block mb-1.5">Jurusan (Peserta) <span className="text-red-500">*</span></label>
              <input 
                type="text" 
            ...
            <div>
              <label className="text-xs font-semibold text-slate-600 block mb-1.5">Kategori Angkatan <span className="text-red-500">*</span></label>
              <div className="relative">
                <select 
                  className="w-full bg-white border border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-xl px-4 py-2.5 outline-none font-medium text-sm transition-all text-slate-800 appearance-none cursor-pointer" 
